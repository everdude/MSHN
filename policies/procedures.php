...
<head>
	...
	<title>Procedures | MSHN - Mid-State Health Network</title>
...
<section id="content">
	<h2>Procedures</h2>
		<p id="related">Related: <a href="policies.php">Policies</a> | <a href="forms.php">Forms</a></p>

<ul>
<?php $data = simplexml_load_file("xml/policies.xml");
$procedures = $data->xpath("/policies/policy/related/rprocedure");
