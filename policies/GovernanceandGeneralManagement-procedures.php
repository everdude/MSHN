...
<head>
	...
	<title>Governance and General Management Procedures | MSHN - Mid-State Health Network</title>
	<meta name="description" content="Governance and General Management Procedures">
...
<?php include_once($_SERVER["DOCUMENT_ROOT"].'/includes/header.php'); ?>
			...
			<section id="content">
			<h2>Governance and General Management Procedures</h2>
			<p id="related">Related: <a href="GovernanceandGeneralManagement-policies.php">Policies</a></p>
			<ul>
<?php 
$data = simplexml_load_file("xml/policies.xml");
$procedures = $data->xpath("/policies/policy[@chapter='Governance and General Management']/related/rprocedure");
