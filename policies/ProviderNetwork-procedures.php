...
<head>
	...
	<title>Provider Network Procedures | MSHN - Mid-State Health Network</title>
	<meta name="description" content="Provider Network Procedures">
...
<?php include_once($_SERVER["DOCUMENT_ROOT"].'/includes/header.php'); ?>
			...
			<section id="content">
			<h2>Provider Network Procedures</h2>
			<p id="related">Related: <a href="ProviderNetwork-forms.php">Forms</a> | <a href="ProviderNetwork-policies.php">Policies</a></p>
			<ul>
<?php 
$data = simplexml_load_file("xml/policies.xml");
$procedures = $data->xpath("/policies/policy[@chapter='Provider Network']/related/rprocedure");
