...
<head>
	...
	<title>Utilization Management Procedures | MSHN - Mid-State Health Network</title>
	<meta name="description" content="Utilization Management Procedures">
...
<?php include_once($_SERVER["DOCUMENT_ROOT"].'/includes/header.php'); ?>
			...
			<section id="content">
			<h2>Utilization Management Procedures</h2>
			<p id="related">Related: <a href="UtilizationManagement-policies.php">Policies</a></p>
			<ul>
<?php 
$data = simplexml_load_file("xml/policies.xml");
$procedures = $data->xpath("/policies/policy[@chapter='Utilization Management']/related/rprocedure");
