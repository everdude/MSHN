...
<head>
	...
	<title>Provider Network Forms | MSHN - Mid-State Health Network</title>
	<meta name="description" content="Provider Network Forms">
...
<?php include_once($_SERVER["DOCUMENT_ROOT"].'/includes/header.php'); ?>
			...
			<section id="content">
			<h2>Provider Network Forms</h2>
			<p class="related">Related: <a href="ProviderNetwork-policies.php">Policies</a> | <a href="ProviderNetwork-procedures.php">Procedures</a></p>
			<ul>
<?php 
$data = simplexml_load_file("xml/policies.xml");
$forms = $data->xpath("/policies/policy[@chapter='Provider Network']/related/rform");
