...
<head>
	...
	<title>Quality Forms | MSHN - Mid-State Health Network</title>
	<meta name="description" content="Quality Forms">
...
<?php include_once($_SERVER["DOCUMENT_ROOT"].'/includes/header.php'); ?>
			...
			<section id="content">
			<h2>Quality Forms</h2>
			<p class="related">Related: <a href="Quality-policies.php">Policies</a> | <a href="Quality-procedures.php">Procedures</a></p>
			<ul>
<?php 
$data = simplexml_load_file("xml/policies.xml");
$forms = $data->xpath("/policies/policy[@chapter='Quality']/related/rform");
