...
<head>
	...
	<title>Service Delivery System Procedures | MSHN - Mid-State Health Network</title>
	<meta name="description" content="Service Delivery System Procedures">
...
<?php include_once($_SERVER["DOCUMENT_ROOT"].'/includes/header.php'); ?>
			...
			<section id="content">
			<h2>Service Delivery System Procedures</h2>
			<p id="related">Related: <a href="ServiceDeliverySystem-policies.php">Policies</a></p>
			<ul>
<?php 
$data = simplexml_load_file("xml/policies.xml");
$procedures = $data->xpath("/policies/policy[@chapter='Service Delivery System']/related/rprocedure");
