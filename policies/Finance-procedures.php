...
<head>
	...
	<title>Finance Procedures | MSHN - Mid-State Health Network</title>
	<meta name="description" content="Finance Procedures">
...
<?php include_once($_SERVER["DOCUMENT_ROOT"].'/includes/header.php'); ?>
			...
			<section id="content">
			<h2>Finance Procedures</h2>
			<p id="related">Related: <a href="Finance-policies.php">Policies</a></p>
			<ul>
<?php 
$data = simplexml_load_file("xml/policies.xml");
$procedures = $data->xpath("/policies/policy[@chapter='Finance']/related/rprocedure");
