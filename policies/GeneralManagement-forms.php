...
<head>
	...
	<title>General Management Forms | MSHN - Mid-State Health Network</title>
	<meta name="description" content="General Management Forms">
...
<?php include_once($_SERVER["DOCUMENT_ROOT"].'/includes/header.php'); ?>
			...
			<section id="content">
			<h2>General Management Forms</h2>
			<p class="related">Related: <a href="GeneralManagement-policies.php">Policies</a> | <a href="GeneralManagement-procedures.php">Procedures</a></p>
			<ul>
<?php 
$data = simplexml_load_file("xml/policies.xml");
$forms = $data->xpath("/policies/policy[@chapter='General Management']/related/rform");
