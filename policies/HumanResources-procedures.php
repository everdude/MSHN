...
<head>
	...
	<title>Human Resources Procedures | MSHN - Mid-State Health Network</title>
	<meta name="description" content="Human Resources Procedures">
...
<?php include_once($_SERVER["DOCUMENT_ROOT"].'/includes/header.php'); ?>
			...
			<section id="content">
			<h2>Human Resources Procedures</h2>
			<p id="related">Related: <a href="HumanResources-forms.php">Forms</a> | <a href="HumanResources-policies.php">Policies</a></p>
			<ul>
<?php 
$data = simplexml_load_file("xml/policies.xml");
$procedures = $data->xpath("/policies/policy[@chapter='Human Resources']/related/rprocedure");
