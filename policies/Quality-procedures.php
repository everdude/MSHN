...
<head>
	...
	<title>Quality Procedures | MSHN - Mid-State Health Network</title>
	<meta name="description" content="Quality Procedures">
...
<?php include_once($_SERVER["DOCUMENT_ROOT"].'/includes/header.php'); ?>
			...
			<p id="related">Related: <a href="Quality-forms.php">Forms</a> | <a href="Quality-policies.php">Policies</a></p>
			<ul>
<?php 
$data = simplexml_load_file("xml/policies.xml");
$procedures = $data->xpath("/policies/policy[@chapter='Quality']/related/rprocedure");
